        ...
        {BAR_HEIGHTS.map((h, i) => (
          <div
            ...
            style={{
              ...
              width: 6,
              borderRadius: 1,
              background: i < bars ? (weak ? '#ff2a1f' : '#39ff14') : '#1a1a1a',
            }}
          />
        ))}
      </div>
  ...
  return (
    <div
      style={{
        ...
        gap: 20,
        padding: '14px 24px',
        borderBottom: '1px solid rgba(57,255,20,.05)',
      }}
    >
      <span
        style={{
    ...
    >
      ...
      <div
        style={{
          ...
          gap: 8,
          padding: '12px 22px',
          borderBottom: '1px solid rgba(57,255,20,.06)',
      ...
      >
        {['#ff2a1f', '#e5a000', '#39ff14'].map((c, i) => (
          <div
            key={i}
            style={{ width: 7, height: 7, borderRadius: '50%', background: c, opacity: 0.85 }}
          />
        ))}
        <span
          style={{
        ...
        {entries.map((e, i) => (
          <div
            ...
            style={{
              ...
              color: COLOR[e.type],
              opacity: i === entries.length - 1 ? 1 : 0.5,
            }}
          >
            {e.text}
          </div>
...
const Help = () => {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setSigLevel(prev =>
        Math.min(4, Math.max(0, prev + (Math.random() < 0.4 ? (Math.random() < 0.5 ? -1 : 1) : 0)))
      );
    }, 2200);
    return () => clearInterval(id);
  }, []);
  ...
  const glStartDecode = useCallback(() => {
    ...
    decodeIntervalRef.current = setInterval(() => {
      ...
      if (progressRef.current >= 1) {
        ...
        if (ctaRef.current) {
          ctaRef.current.textContent = '✓ TRANSMISSION RECOVERED';
          ctaRef.current.dataset.success = 'true';
        }
  ...
  const glStopDecode = useCallback(() => {
    ...
    if (ctaRef.current)  {
      ctaRef.current.textContent = '[ HOVER TO DECODE ]';
      delete ctaRef.current.dataset.success;
    }
    glStartPassive();
  }, [glStartPassive]);
  ...
  return (
    ...
    >
      <style>{`
        ...
        .gl-decode-block:hover,
        .gl-decode-block.gl-decoding {
          border-color: rgba(255,42,31,.5) !important;
          box-shadow: 0 0 32px rgba(255,42,31,.06);
        }
        .gl-decode-block.gl-decoded {
          border-color: rgba(57,255,20,.4) !important;
          box-shadow: 0 0 32px rgba(57,255,20,.06);
        }
        ...
        @media (max-width: 600px) {
          .help-root { padding: 40px 16px 72px !important; }
        }
      `}</style>
      ...
      >
        ...
        <div
          style={{
            ...
            paddingBottom: 36,
            marginBottom: 52,
            borderBottom: '1px solid rgba(57,255,20,.07)',
          }}
        >
          <span
            style={{
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: 8 }}>
            ...
            >
              CLASSIFIED{' '}
              <span style={{ color: '#39ff14' }}>ACCESS</span>
            </span>
          </div>
          <span
            style={{
          ...
          >
            ...
            <div
              style={{
                ...
                right: 0,
                height: 52,
                background: 'linear-gradient(transparent, rgba(57,255,20,.012), transparent)',
        ...
        >
          ...
          <div
            style={{
              ...
              right: 0,
              height: 64,
              background: 'linear-gradient(transparent, rgba(57,255,20,.018))',
            }}
          />
